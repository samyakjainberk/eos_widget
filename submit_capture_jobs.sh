...
declare -a JOBS=(
  ...
  # ---- angle-pair (2 samples): §18 per-sample projections + §19 grad-norm vs D²(NTK); sweep angle / labels / norms / lr ----
  "anglepair_a90_opp|$AP --lr 0.05 --set angle=90 --set norm1=1 --set norm2=1 --set lab1=1 --set lab2=-1"
  "anglepair_a30_opp|$AP --lr 0.05 --set angle=30 --set norm1=1 --set norm2=1 --set lab1=1 --set lab2=-1"
  "anglepair_a150_opp|$AP --lr 0.05 --set angle=150 --set norm1=1 --set norm2=1 --set lab1=1 --set lab2=-1"
  "anglepair_a90_same|$AP --lr 0.05 --set angle=90 --set norm1=1 --set norm2=1 --set lab1=1 --set lab2=1"
  "anglepair_a60_uneqnorm|$AP --lr 0.05 --set angle=60 --set norm1=1 --set norm2=2 --set lab1=1 --set lab2=-1"
  "anglepair_a90_hilr|$AP --lr 0.2 --set angle=90 --set norm1=1 --set norm2=1 --set lab1=1 --set lab2=-1"
  "anglepair_a120_s1|$AP --lr 0.08 --seed 1 --set angle=120 --set norm1=1 --set norm2=1 --set lab1=1 --set lab2=-1"
